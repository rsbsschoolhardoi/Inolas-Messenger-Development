...
export const THEMES_PART1: ChatTheme[] = [
  // ==================== 1. EDITORIAL & MINIMAL ====================
  {
    ...
    name: 'Clean Slate',
    category: 'minimal',
    description: 'Crisp sovereign canvas with subtle micro-motifs and matte obsidian sent bubbles.',
    bgClass: 'bg-[#fafbfc] dark:bg-[#070a12] text-[#0d253d] dark:text-[#f8fafc]',
    bgStyle: {
    ...
    bubble: {
      sentBg: 'bg-[#0d253d] dark:bg-[#121826]',
      sentText: 'text-[#f8fafc] font-[460]',
      receivedBg: 'bg-white dark:bg-[#0b101b]',
      receivedText: 'text-[#0d253d] dark:text-[#f8fafc]',
      borderStyle: 'border border-[#e3e8ee] dark:border-[#1f293d] shadow-2xs',
      isSentDark: true,
      isReceivedDark: false,
      subtextSent: 'text-slate-300/80',
      subtextReceived: 'text-[#64748d] dark:text-[#94a3b8]',
      linkSent: 'text-white underline font-semibold decoration-white/50 hover:decoration-white',
      linkReceived: 'text-[#533afd] dark:text-[#818cf8] underline font-medium',
      cardBgSent: 'bg-white/10 border-white/20 text-white',
      cardBgReceived: 'bg-[#f4f6f8] dark:bg-[#121826] border-[#e3e8ee] dark:border-[#1f293d] text-[#0d253d] dark:text-[#f8fafc]'
    },
    previewGradient: 'from-[#fafbfc] to-[#e3e8ee] dark:from-[#070a12] to-[#121826]',
    badge: 'Sovereign',
    headerBg: 'bg-white/95 dark:bg-[#070a12]/95 backdrop-blur-xl',
    headerBorder: 'border-b border-[#e3e8ee] dark:border-[#1f293d]',
    headerText: 'text-[#0d253d] dark:text-white',
    headerSubtext: 'text-[#64748d] dark:text-[#94a3b8]',
    composerBg: 'bg-white/95 dark:bg-[#070a12]/95 backdrop-blur-xl',
    composerBorder: 'border-t border-[#e3e8ee] dark:border-[#1f293d]',
    innerInputBg: 'bg-[#f4f6f8] dark:bg-[#0f1523]',
    innerInputBorder: 'border border-[#e3e8ee] dark:border-[#1f293d] shadow-2xs',
    innerInputText: 'text-[#0d253d] dark:text-[#f8fafc] placeholder:text-[#94a3b8] dark:placeholder:text-[#64748d]',
    actionButtonText: 'text-[#64748d] dark:text-[#94a3b8]',
    actionButtonHoverBg: 'hover:bg-[#e9eef5] dark:hover:bg-[#1a2234]',
    actionButtonActiveBg: 'bg-[#533afd] text-white',
    accentBg: 'bg-[#533afd] hover:bg-[#4326ea] shadow-xs',
